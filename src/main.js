        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    ...
                    return [3, 7];
                case 5: return [4, collection.deleteOne({ _id: portions[1].itemId })];
                case 6:
                    _b.sent();
                    return [2, {
                            type: types_1.ObjectModifyType.Delete,
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    ...
                    return [4, delFile(host, drive, relativePath)];
                case 5:
                    _b.sent();
                ...
                case 6: return [2, new Promise(function (resolve, reject) {
                        var sdk = getS3DriveSdk(drive);
                        var s3 = new sdk.S3({ apiVersion: types_1.Constants.amazonS3ApiVersion });
                        var config = {
                        ...
                        s3.upload(config, function (err, result) {
                ...
                case 7: throw types_1.StatusCode.NotImplemented;
                case 8: return [2];
            }
        });
    });
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    switch (_a) {
                        case types_1.SourceType.File: return [3, 1];
                        case types_1.SourceType.S3: return [3, 4];
                    }
                    return [3, 3];
                case 1: return [4, fsPromises.readdir(path.join(drive.address, dir), { withFileTypes: true })];
                case 2:
                    list = _b.sent();
                    return [2, list.map(function (item) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    switch (_a) {
                        case types_1.SourceType.File: return [3, 1];
                        case types_1.SourceType.S3: return [3, 3];
                    }
                    return [3, 5];
                case 1:
                    _path = path.join(drive.address, relativePath);
                    return [4, fs.unlink(_path)];
                case 2:
                    _b.sent();
                    return [3, 6];
                case 3:
                    s3 = new AWS.S3({ apiVersion: types_1.Constants.amazonS3ApiVersion });
                    return [4, s3.deleteObject({ Bucket: drive.address, Key: path.basename(relativePath) })];
                case 4:
                    data = _b.sent();
                    return [3, 6];
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 3:
                    ...
                    return [4, get(pack, types_1.SysCollection.forms)];
                case 4:
                    forms = _g.sent();
