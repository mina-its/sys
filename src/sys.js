...
function getSigninUrl(cn, back) {
    let url = exports.glob.serviceConfigs[cn.db].sso ? process.env.SSO_SIGNIN_URL : toPublicUrl(cn, types_1.Constants.defaultSignInUri, true);
    if (back)
